...
const addDoctor = async (req, res) => {
  ...
  try {
    ...
    if (!foundDepartment) return res.status(404).json({ message: 'Department not found' });
...
const updateDoctor = async (req, res) => {
  ...
  try {
    ...
    // Check conflicts excluding this doctor
    ...
    // ✅ If a new profile pic was uploaded, update it
    if (req.file) {
